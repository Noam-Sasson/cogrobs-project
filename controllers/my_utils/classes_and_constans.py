...
CLEANER_CHANNEL = 4
DRONE_CHANNEL = 5
WORLD_GENERATOR_CHANNEL = 6
PEDESTRIAN_CHANNEL = 7
FOOD_ITEMS = {"dish1": 35, "dish2": 60, "dish3": 45, "dish4": 50, "dish5": 15}

RATE_OF_ARRIVAL = 10/(2*60*1000)
RATE_OF_PONDER_TIME = 10/(1*60*1000)
RATE_OF_EATING_TIME = 10/(2*60*1000)
RATE_OF_PREP_TIME = 10/(1*60*1000)
RATE_OF_CLEANING_TIME = 10/(1*60*1000)
